...
const WordDetailCard = (prop: WordDetailCardProp) => {
        ...
        <section>
            ...
            <Card>
                <TabContext value={tabIndex} >
                    <TabList onChange={handleChangeTab} aria-label='card navigation examples' defaultValue={1}>
                        {
                                ...
                                return (
                                    <TabPanel key={index + 1} value={index + 1}>
                                        <Typography className='mbe-6'>
                                            <HtmlParser htmlContent={desc.description}/>
                                        </Typography>
                                    </TabPanel>
                                )
                            })
